    ...
    >
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        >
          ...
          >
            Contact{" "}
            <span className="text-transparent bg-gradient-to-r from-green-400 via-teal-400 to-cyan-400 bg-clip-text">
              Us
            </span>
          </motion.h1>

          <motion.div
            className="w-32 h-px bg-gradient-to-r from-transparent via-green-400 to-transparent mx-auto mb-8"
            initial={{ scaleX: 0 }}
